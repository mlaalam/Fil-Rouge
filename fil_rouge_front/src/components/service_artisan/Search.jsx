...
function Search({villeInput,setVilleInput,categoryInput,setCategoryInput}) {
  const handleSearch = () => {
    setVilleInput(villeInput);
  ...
  return (
    <div className="mx-auto max-w-[80%] mt-16">
      ...
      <div className="flex flex-col md:flex-row md:justify-center md:items-center  rounded-2xl md:rounded-full p-2 gap-2 md:gap-4">
        ...
        />
        <button onClick={handleSearch} className="bg-[#FA7B0C] hover:bg-orange-600 text-white px-8 py-4 rounded-xl md:rounded-full flex items-center justify-center gap-2 font-bold">
